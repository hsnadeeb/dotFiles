...
# 03 Shell behaviour
# 04 Completion (lazy)
# 05 Plugin loading (deferred — after first prompt)
# 06 Aliases — general
# 07 Aliases — Docker / infra
...
# ==============================================================================
# 05) PLUGIN LOADING (startup — sourced during shell init)
# ==============================================================================
_zrc_load_plugins() {
...
# ==============================================================================
# 13) POWERLEVEL10K PROMPT (fast git + exit codes; replaces old section 05)
# ==============================================================================
...
# Source Powerlevel10k (runs config wizard on first launch).
